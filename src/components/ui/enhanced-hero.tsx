              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-6 sm:mb-8 md:mb-10 text-sm sm:text-base md:text-lg leading-relaxed">
                    Advanced AI conversations with natural language processing
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <InteractiveButton
                      ...
                      variant="hero-outline" size="lg" className="w-full text-sm sm:text-base md:text-lg font-semibold py-3 sm:py-4">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-10 text-lg leading-relaxed">
                    Native regional language support with cultural context
                    understanding for authentic local conversations
                  </p>
